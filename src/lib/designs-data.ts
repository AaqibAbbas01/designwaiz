...
export const DESIGN_CATEGORIES: DesignCategory[] = [
  ...
  { id: "balcony", name: "Balcony", slug: "balcony", thumbnail: picsumUrl("dw-balcony-hero", 600, 450), count: 12 },
  { id: "tv-unit", name: "TV Unit", slug: "tv-unit", thumbnail: picsumUrl("dw-tvunit-hero", 600, 450), count: 12 },
  { id: "bathroom", name: "Bathroom", slug: "bathroom", thumbnail: picsumUrl("dw-bathroom-hero", 600, 450), count: 12 },
  ...
  { id: "wall-design", name: "Wall Design", slug: "wall-design", thumbnail: picsumUrl("dw-wall-hero", 600, 450), count: 12 },
  { id: "door-design", name: "Door Design", slug: "door-design", thumbnail: picsumUrl("dw-door-hero", 600, 450), count: 12 },
  { id: "crockery-unit", name: "Crockery Unit", slug: "crockery-unit", thumbnail: picsumUrl("dw-crockery-hero", 600, 450), count: 12 },
...
export const ALL_DESIGN_IMAGES: DesignImage[] = [
  ...
  ...makeImages("balcony", 12),
  ...makeImages("tv-unit", 12),
  ...makeImages("bathroom", 12),
  ...makeImages("mandir", 12),
  ...makeImages("dining-room", 12),
  ...makeImages("wall-design", 12),
  ...makeImages("door-design", 12),
  ...makeImages("crockery-unit", 12),
