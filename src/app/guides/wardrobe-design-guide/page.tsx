          ...
          <div className="grid lg:grid-cols-[1fr_280px] gap-12 items-start">
            <article className="space-y-10">
              ...
              <div className="rounded-[20px] bg-gradient-to-r from-[#E8E2D8] to-[#F0EDE8] p-8 border border-dw-border">
                ...
                <a href="/#consultation" className="inline-flex items-center rounded-full bg-dw-mustard px-6 py-3 font-semibold text-white hover:bg-dw-olive transition-colors">Get Free Wardrobe Consultation</a>
              </div>
            </article>
